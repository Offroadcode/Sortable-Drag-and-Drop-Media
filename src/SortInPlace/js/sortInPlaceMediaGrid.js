(function() {
    ...
    function SortInPlaceMediaGridDirective($filter, mediaHelper) {
        ...
        var directive = {
            restrict: 'E',
            replace: true,
            templateUrl: '/App_Plugins/SortInPlace/views/sortInPlaceMediaGrid.html',
            scope: {
                items: '=',
                onDetailsHover: "=",
                onClick: '=',
    ...
    angular.module('umbraco.directives').directive('sortInPlaceUmbMediaGrid', SortInPlaceMediaGridDirective);
